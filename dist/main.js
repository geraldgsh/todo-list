...
/*!****************************!*\
  !*** ./src/DOM/taskDOM.js ***!
  \****************************/
/*! exports provided: renderTaskCard, iterateTasks, renderSingleTask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************!*\
  !*** ./src/control/taskControl.js ***!
  \************************************/
/*! exports provided: addTaskToProject, completeTask, removeTask, updateTask, editTask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _control_projectControl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./control/projectControl */ \"./src/control/projectControl.js\");\n/* harmony import */ var _control_taskControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./control/taskControl */ \"./src/control/taskControl.js\");\n/* harmony import */ var _DOM_taskDOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DOM/taskDOM */ \"./src/DOM/taskDOM.js\");\n/* harmony import */ var _modules_localStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/localStorage */ \"./src/modules/localStorage.js\");\n/* harmony import */ var _modules_localStorage__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _modules_constructor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/constructor */ \"./src/modules/constructor.js\");\n/* harmony import */ var _modules_bulmaModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/bulmaModal */ \"./src/modules/bulmaModal.js\");\n/* harmony import */ var _starter_starterProjectTask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./starter/starterProjectTask */ \"./src/starter/starterProjectTask.js\");\n/* harmony import */ var _DOM_projectInput__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DOM/projectInput */ \"./src/DOM/projectInput.js\");\n/* harmony import */ var _DOM_taskInput__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DOM/taskInput */ \"./src/DOM/taskInput.js\");\n/* eslint-disable no-unused-vars */\n\n\n\n\n\n\n\n\n\n\n\n// show todays date\nconst showDate = (() => {\n  const dateElement = document.getElementById('date');\n  const options = { weekday: 'long', month: 'short', day: 'numeric' };\n  const today = new Date();\n  dateElement.innerHTML = today.toLocaleDateString('en-US', options);\n})();\n\nconst addTask = (() => {\n  document.addEventListener('DOMContentLoaded', () => {\n    document.getElementById('addTask').addEventListener('click', _DOM_taskInput__WEBPACK_IMPORTED_MODULE_8__[\"default\"]);\n  });\n})();\n\nconst addProject = (() => {\n  document.addEventListener('DOMContentLoaded', () => {\n    document.getElementById('addProject').addEventListener('click', _DOM_projectInput__WEBPACK_IMPORTED_MODULE_7__[\"default\"]);\n  });\n})();\n\nconst purge = (() => {\n  const clear = document.querySelector('.clear');\n  clear.addEventListener('click', () => {\n    localStorage.clear();\n    window.location.reload();\n  });\n})();\n\nconst dropdownRender = (() => {\n  const listProject = document.getElementById('listProject');\n  listProject.addEventListener('change', _DOM_taskDOM__WEBPACK_IMPORTED_MODULE_2__[\"iterateTasks\"]);\n})();\n\nconst removeProject = (() => {\n  const pid = document.getElementById('listProject').value;\n  const deleteProject = document.getElementById('deleteProject');\n  deleteProject.addEventListener('click', () => {\n    _modules_constructor__WEBPACK_IMPORTED_MODULE_4__[\"projectList\"].splice(pid, 1);\n    Object(_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__[\"updateLocalStorage\"])(_modules_constructor__WEBPACK_IMPORTED_MODULE_4__[\"projectList\"]);\n    window.location.reload();\n  });\n})();\n\nconst modalOpen = (() => {\n  const newProject = document.querySelector('#newProject');\n  const projectModal = new _modules_bulmaModal__WEBPACK_IMPORTED_MODULE_5__[\"BulmaModal\"]('#projectModal');\n  const newTask = document.querySelector('#newTask');\n  const taskModal = new _modules_bulmaModal__WEBPACK_IMPORTED_MODULE_5__[\"BulmaModal\"]('#taskModal');\n  newProject.addEventListener('click', () => {\n    projectModal.show();\n  });\n  newTask.addEventListener('click', () => {\n    taskModal.show();\n  });\n})();\n\nconst taskUpdate = (() => {\n  const list = document.getElementById('list');\n  // target the items create dynamically\n  list.addEventListener('click', (event) => {\n    event.preventDefault();\n    const element = event.target; // return the clicked element inside list\n    if (element.attributes.job === undefined) {\n      let filler;\n    } else {\n      const elementJob = element.attributes.job.value; // complete or delete\n      if (elementJob === 'complete') {\n        Object(_control_taskControl__WEBPACK_IMPORTED_MODULE_1__[\"completeTask\"])(element);\n      } else if (elementJob === 'delete') {\n        Object(_control_taskControl__WEBPACK_IMPORTED_MODULE_1__[\"removeTask\"])(element);\n      } else if (elementJob === 'edit') {\n        Object(_control_taskControl__WEBPACK_IMPORTED_MODULE_1__[\"editTask\"])(element);\n      } else if (elementJob === 'save') {\n        Object(_control_taskControl__WEBPACK_IMPORTED_MODULE_1__[\"updateTask\"])(element);\n      }\n    }\n  });\n})();\n\nconst start = (() => {\n  const projectListing = JSON.parse(localStorage.getItem('projectList'));\n  if (projectListing === null) {\n    Object(_starter_starterProjectTask__WEBPACK_IMPORTED_MODULE_6__[\"starterProject\"])();\n  } else {\n    projectListing.forEach((project) => {\n      _modules_constructor__WEBPACK_IMPORTED_MODULE_4__[\"projectList\"].push(project);\n    });\n  }\n  Object(_control_projectControl__WEBPACK_IMPORTED_MODULE_0__[\"renderProjects\"])();\n  Object(_DOM_taskDOM__WEBPACK_IMPORTED_MODULE_2__[\"iterateTasks\"])();\n})();\n\n\n//# sourceURL=webpack:///./src/index.js?");

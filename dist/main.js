...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderProjects\", function() { return renderProjects; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addProjectToList\", function() { return addProjectToList; });\n/* harmony import */ var _DOM_projectDOM_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../DOM/projectDOM.js */ \"./src/DOM/projectDOM.js\");\n/* harmony import */ var _modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/constructor.js */ \"./src/modules/constructor.js\");\n/* harmony import */ var _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/localStorage.js */ \"./src/modules/localStorage.js\");\n/* harmony import */ var _modules_bulmaModal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/bulmaModal.js */ \"./src/modules/bulmaModal.js\");\n\r\n\r\n\r\n\r\n\r\nconst renderProjects = () => {\r\n  const projectList = JSON.parse(localStorage.getItem('projectList'));\r\n  if (projectList === null) {\r\n  } else {\r\n    projectList.forEach((project) => {\r\n      Object(_DOM_projectDOM_js__WEBPACK_IMPORTED_MODULE_0__[\"addProjectToTaskDropdown\"])(project.name, project.id);\r\n    });\r\n  }  \r\n};\r\n\r\nconst addProjectToList = () => {  \r\n  const projectModal = new _modules_bulmaModal_js__WEBPACK_IMPORTED_MODULE_3__[\"BulmaModal\"](\"#projectModal\");\r\n  const projectInput = document.getElementById('projectInput').value;\r\n  if (_modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__[\"projectList\"].some((project) => project.name === projectInput)) {\r\n    alert('Duplicate entry');\r\n  } else {\r\n    const id = _modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__[\"projectList\"].length;\r\n    const newProject = Object(_modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__[\"Project\"])(projectInput, id);\r\n    _modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__[\"projectList\"].push(newProject);\r\n    Object(_modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__[\"updateLocalStorage\"])(_modules_constructor_js__WEBPACK_IMPORTED_MODULE_1__[\"projectList\"]);\r\n    Object(_DOM_projectDOM_js__WEBPACK_IMPORTED_MODULE_0__[\"addProjectToTaskDropdown\"])(projectInput, id)\r\n    projectModal.close();\r\n  }\r\n}\n\n//# sourceURL=webpack:///./src/control/projectControl.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _control_projectControl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./control/projectControl.js */ \"./src/control/projectControl.js\");\n/* harmony import */ var _control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./control/taskControl.js */ \"./src/control/taskControl.js\");\n/* harmony import */ var _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/localStorage.js */ \"./src/modules/localStorage.js\");\n/* harmony import */ var _modules_constructor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/constructor.js */ \"./src/modules/constructor.js\");\n/* harmony import */ var _modules_BulmaModal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/BulmaModal.js */ \"./src/modules/BulmaModal.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n//show todays date\r\nconst showDate = (() => {\r\n  const dateElement = document.getElementById(\"date\");  \r\n  const options = {weekday:\"long\", month:\"short\", day:\"numeric\"};\r\n  const today = new Date();\r\n  dateElement.innerHTML = today.toLocaleDateString(\"en-US\", options);\r\n})();\r\n\r\nconst addTask = (() => {\r\n  document.addEventListener('DOMContentLoaded', () => {\r\n    document.getElementById('addTask').addEventListener('click', _control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"addTaskToProject\"]);\r\n  });\r\n})();\r\n\r\nconst addProject = (() => {\r\n  document.addEventListener('DOMContentLoaded', () => {\r\n    document.getElementById('addProject').addEventListener('click', _control_projectControl_js__WEBPACK_IMPORTED_MODULE_0__[\"addProjectToList\"]);\r\n  });\r\n})();\r\n\r\nconst purge = (() => {\r\n  const clear = document.querySelector(\".clear\");\r\n  clear.addEventListener(\"click\", () => {\r\n    localStorage.clear();\r\n    window.location.reload();\r\n  });\r\n})();\r\n\r\nconst dropdownRender = (() => {\r\n  const listProject = document.getElementById(\"listProject\");\r\n  listProject.addEventListener('change', _control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"iterateTasks\"])\r\n})();\r\n\r\nconst removeProject = (() => {\r\n  const pid = document.getElementById(\"listProject\").value;\r\n  const deleteProject = document.getElementById('deleteProject');\r\n  deleteProject.addEventListener('click', () => {\r\n    _modules_constructor_js__WEBPACK_IMPORTED_MODULE_3__[\"projectList\"].splice(pid, 1);\r\n    Object(_modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__[\"updateLocalStorage\"])(_modules_constructor_js__WEBPACK_IMPORTED_MODULE_3__[\"projectList\"]);\r\n    window.location.reload();\r\n  });\r\n})();\r\n\r\nconst modalOpen = (() => {\r\n  const newProject = document.querySelector(\"#newProject\");\r\n  const projectModal = new _modules_BulmaModal_js__WEBPACK_IMPORTED_MODULE_4__[\"BulmaModal\"](\"#projectModal\");\r\n  const newTask = document.querySelector(\"#newTask\");\r\n  const taskModal = new _modules_BulmaModal_js__WEBPACK_IMPORTED_MODULE_4__[\"BulmaModal\"](\"#taskModal\");\r\n  newProject.addEventListener(\"click\", function () {\r\n    projectModal.show()  \r\n  });  \r\n  newTask.addEventListener(\"click\", function () {\r\n    taskModal.show()\r\n  });\r\n})()\r\n\r\nconst taskUpdate = (() => {\r\n  const list = document.getElementById(\"list\");\r\n  // target the items create dynamically\r\n  list.addEventListener(\"click\", function(event) {\r\n    event.preventDefault();\r\n    const element =  event.target; //return the clicked element inside list\r\n    if (element.attributes.job == undefined) {\r\n    } else {      \r\n      const elementJob = element.attributes.job.value; // complete or delete \r\n      if (elementJob == \"complete\") {      \r\n        Object(_control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"completeTask\"])(element);      \r\n      } else if (elementJob == \"delete\") {\r\n        Object(_control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"removeTask\"])(element);\r\n      } else if (elementJob == \"edit\") {\r\n        Object(_control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"editTask\"])(element);\r\n      } else if (elementJob == \"save\") {\r\n        Object(_control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"updateTask\"])(element); \r\n      }\r\n    }    \r\n  });\r\n})();\r\n\r\nconst start = (() => {\r\n  const projectListing = JSON.parse(localStorage.getItem('projectList'));\r\n  if (projectListing === null) {\r\n  } else {\r\n    projectListing.forEach((project) => {\r\n      _modules_constructor_js__WEBPACK_IMPORTED_MODULE_3__[\"projectList\"].push(project);\r\n    });\r\n  }\r\n  Object(_control_projectControl_js__WEBPACK_IMPORTED_MODULE_0__[\"renderProjects\"])();\r\n  Object(_control_taskControl_js__WEBPACK_IMPORTED_MODULE_1__[\"iterateTasks\"])();\r\n})();\r\n\r\n\n\n//# sourceURL=webpack:///./src/index.js?");
